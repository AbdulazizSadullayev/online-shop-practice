...
const EquipmentCard: React.FC<{ item: Equipment }> = ({ item }) => {
  ...
  return (
    <div
      className="bg-white rounded-4xl p-6 shadow-sm border border-gray-150 flex flex-col items-center relative max-w-[350px] cursor-pointer hover:shadow-md transition-shadow"
      role="button"
      tabIndex={0}
      onClick={goToDetail}
      onKeyDown={(e) => {
